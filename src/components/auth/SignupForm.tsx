...
export default function SignupForm({ onSuccess, onSwitchToLogin }: SignupFormProps) {
  ...
  const benefits = [
    { icon: Gift, text: '20% off on first order', color: 'text-secondary-brand' },
    { icon: Percent, text: 'Exclusive member deals', color: 'text-accent-brand' },
    { icon: ShoppingBag, text: 'Free delivery above ₹199', color: 'text-primary-brand' },
        ...
        <div className="relative z-10 flex flex-col justify-between w-full">
            ...
            <Link href="/">
              <div className="flex items-center space-x-3 cursor-pointer group">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-90">Start saving on groceries today</p>
                </div>
              </div>
            </Link>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              ...
              <p className="text-sm opacity-90">&quot;Best grocery delivery service! Fresh products and fast delivery.&quot;</p>
              <p className="text-xs mt-2 opacity-75">- 10,000+ verified customers</p>
            </div>
          </div>
        ...
        >
          ...
          <div className="lg:hidden text-center mb-8">
            <Link href="/">
              ...
              <p className="text-sm text-neutral-600">Start saving on groceries today</p>
            </Link>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-neutral-100">
            <div className="mb-8">
              ...
              <p className="text-neutral-600">Sign up to get started with exclusive offers</p>
            </div>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <label htmlFor="terms" className="ml-2 text-sm text-neutral-700">
                  I agree to the <button type="button" className="text-primary-brand hover:text-primary-hover font-medium">Terms of Service</button> and <button type="button" className="text-primary-brand hover:text-primary-hover font-medium">Privacy Policy</button>
                </label>
              </div>
