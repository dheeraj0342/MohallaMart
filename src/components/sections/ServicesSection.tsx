...
const services = [
  {
    ...
    description: 'Fresh groceries, vegetables, fruits, dairy products, and household essentials delivered to your doorstep.',
    features: [
      'Fresh produce daily',
      'Quality guaranteed',
      'Competitive prices'
  ...
  },
  {
    ...
    description: 'Fast delivery of everyday essentials, snacks, beverages, and personal care items in minutes.',
    features: [
  ...
  },
  {
    ...
    description: 'Supporting local businesses and vendors to bring you authentic neighborhood products and services.',
    features: [
                ...
                <ul className="space-y-2 text-sm text-neutral-600">
                  {service.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-center">
                      <CheckCircle className={`h-4 w-4 ${service.checkColor} mr-2`} />
                      {feature}
                    </li>
                  ))}
                </ul>
