...
const featureData: FeatureCategory[] = [
  {
    ...
    features: [
      { name: "User Registration & Login", status: "implemented", description: "Google OAuth & OTP-based authentication via Supabase" },
      ...
      { name: "Notifications", status: "implemented", description: "In-app notifications with sound alerts, bell icon, real-time updates via Convex" },
      ...
      { name: "Wishlist/Favorites", status: "implemented", description: "Save favorite products/shops" },
    ],
  },
  {
    ...
    features: [
      { name: "Shopkeeper Registration", status: "implemented", description: "Apply to become a shopkeeper (Google Auth supported)" },
      { name: "Shopkeeper Login", status: "implemented", description: "Authentication for shopkeepers (Google Auth supported)" },
